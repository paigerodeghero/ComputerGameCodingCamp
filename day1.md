...
- Logistics (IT) 
- Logistics of Think-Group-Share 
...
- **Activity: Classify two games together and think-share**
...
- **Activity: List computer games you have played. We’ll classify it together. Think-Share (9 min)** 
  ...
  - Come back from breakouts when finished (or called back at specific given time). Each partner takes the first game from their partner’s list and shares the name, a summary of the game, and classifies it. We go in order of the groups name alphabet. 
- Game Elements 
...
- **Activity: Pick an existing game, play it and narrate the story.** 
  ...
  - Think-Share: Pick a character in the same game and explain to us one part of the character’s graphical costume. 
- Homework 
