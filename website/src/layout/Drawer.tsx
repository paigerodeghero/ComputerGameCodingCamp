...
import { MaterialButtonExternalLink } from "../utilities/react-router-interop/MaterialButtonLink";
import ListItemLink, {useListItemLinkStyles} from "../utilities/react-router-interop/MaterialListItemLink";
  ...
  return (
    <Drawer open={props.open} anchor="left" onClose={props.onClose}>
      <List component="nav" sx={{
       ...
       <li> <MaterialButtonExternalLink className={useListItemLinkStyles().button}  to="https://twitter.com/EdASE_Research" variant="text" target="_blank" >
             <span>
        Follow Us &nbsp;
